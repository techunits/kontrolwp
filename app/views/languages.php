        	...
        	<div class="section">
				<div class="inside">
                    ...
                    <div class="menu-item lang">
                      <div class="link"><a href="<?php echo APP_PLUGIN_LANG_URL?>" target="_blank">Get <?php echo APP_NAME ?> in your language</a></div>
                      <div class="desc"><?php echo APP_NAME ?> doesn't currently support your language in full. If you would be interested in translating <?php echo APP_NAME ?> to your language from English, we'll throw a bunch of free copies of Kontrol your way in return and give you credit! <a href="<?php echo APP_PLUGIN_LANG_URL?>" target="_blank">View our site for more information</a>.</div>
                  </div>
               </div>
           </div>
		<?php }
