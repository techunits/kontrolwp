<div class="section">
	<div class="inside">
        ...
        <div class="menu-item submit-icon">
            <input type="submit" value="<?php echo __('Edit Post Type','kontrolwp')?>" class="button-primary" />
        </div>
    </div>
</div>
<div class="section">
	<div class="inside">
        ...
        <div class="menu-item add">
            <div class="link"><a href="<?php echo $controller_url?>/add"><?php echo __('Add post types','kontrolwp')?></a></div>
            <div class="desc"><?php echo __('Create a new custom post type','kontrolwp')?>.</div>
        </div>
        <div class="menu-item add">
