	...
	kontrol_auto_fill = new Class({
			...
			*/
			initialize: function(options)
			{
				...
				this.post_name = $('kontrol').getElement('#post-name');
				// The key field
				...
				// Get a json encoded list of all the current post types
				this.cpts = JSON.decode($('kontrol').getElement('#cpts').get('value'));
