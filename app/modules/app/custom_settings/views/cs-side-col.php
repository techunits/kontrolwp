<div class="section">
	<div class="inside">
        <div class="title"><?=__('Manage Settings Groups','kontrolwp')?></div>
        <div class="menu-item add">
            <div class="link"><a href="<?=$controller_url?>/manage/cs"><?=__('Manage custom settings','kontrolwp')?></a></div>
            <div class="desc"><?=__('View and manage all your custom settings and fields','kontrolwp')?>.</div>
        </div>
    </div>
</div>
...
<div class="section">
	<div class="inside">
        ...
        <div class="menu-item add">
            <div class="link"><a href="<?=APP_PLUGIN_URL?>/docs/custom-settings/" target="_blank"><?=__('Code Snippets / Documentation','kontrolwp')?></a></div>
            <div class="desc"><?=__('Grab some code snippets for using these custom settings in the frontend','kontrolwp')?>.</div>
        </div>
    </div>
</div>
