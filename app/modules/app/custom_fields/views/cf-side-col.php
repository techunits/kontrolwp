<div class="section">
	<div class="inside">
        <div class="title"><?php echo __('Manage Custom Fields Groups','kontrolwp')?></div>
        <div class="menu-item add">
            <div class="link"><a href="<?php echo $controller_url?>/manage"><?php echo __('Manage custom fields','kontrolwp')?></a></div>
            <div class="desc"><?php echo __('View and manage all your custom fields','kontrolwp')?>.</div>
        </div>
    </div>
</div>
...
<div class="section">
	<div class="inside">
        ...
        <div class="menu-item add">
            <div class="link"><a href="<?php echo APP_PLUGIN_URL?>/docs/custom-fields/" target="_blank"><?php echo __('Code Snippets / Documentation','kontrolwp')?></a></div>
            <div class="desc"><?php echo __('Grab some code snippets for using these advanced custom fields in the frontend','kontrolwp')?>.</div>
        </div>
    </div>
</div>
