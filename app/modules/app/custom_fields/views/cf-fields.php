 <div class="section group-fields">
    <div class="inside">
        <div class="title icon-menu-title">
            <?php echo $title?> <span class="tip"></span>                 
            <div class="div"></div>
         </div>
        ...
        <div class="section-content" style="padding: 16px; border-top: 1px solid #eaeaea;">
        	<div class="item" style="text-align: right"><input type="button" class="new-cf" value="<?php echo __('Add New Field','kontrolwp')?>" style="" />&nbsp;&nbsp;&nbsp;</div>
        </div>
    </div>
</div>